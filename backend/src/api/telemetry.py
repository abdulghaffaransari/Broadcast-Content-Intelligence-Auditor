...
logger = logging.getLogger("broadcast-audit-telemetry")
# Example log output: "broadcast-audit-telemetry - INFO - Azure Monitor enabled"
...
def setup_telemetry():
    ...
    try:
        ...
        configure_azure_monitor(
            ...
            logger_name="broadcast-audit-tracer"   # Optional: custom tracer name
        )
        # 
